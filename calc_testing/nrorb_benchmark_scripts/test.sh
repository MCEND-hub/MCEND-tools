...
START_TIME=$SECONDS
./mcend ./calc_testing/LiH.static.inp > lih-nofc.txt
echo "closed-shell nofc time" $(($SECONDS - $START_TIME))"s"

tail -n +2 expec.t > expec.t-lih-cs-nofc
rm expec.t
python compare_expec_v2.py expec.t-lih-cs-nofc ./calc_testing/expec.t-lih-cs-ref


mv finalpsi startpsi
START_TIME=$SECONDS
echo "LiH acf test no frozen core with reference values"
./mcend ./calc_testing/LiH.acf.inp > lih-nofc.txt
echo "closed-shell nofc time" $(($SECONDS - $START_TIME))"s"

tail -n +2 expec.t > expec.t-lih-cs-acf-nofc
rm expec.t
python compare_expec_v2.py expec.t-lih-cs-acf-nofc ./calc_testing/expec.t-lih-cs-acf-ref
...
python compare_expec_v2.py expec_spinorbital.t-lih-p-test ./calc_testing/expec_spinorbital.t-lih-p-ref
...
python compare_expec_v2.py expec_spinorbital.t-oh ./calc_testing/expec_spinorbital.t-oh-ref
